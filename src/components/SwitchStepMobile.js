...
export default function SwitchStepMobile({ isStepFilled, handleNext }) {
	...
	return (
		<div className=" lg:hidden bg-white w-full items-center justify-between h-[80px] flex p-5 mt-3">
